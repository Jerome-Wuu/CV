...
class SegNetPredictor(object):
    ...
    _defaults = {
        # 'model_path': 'log_voc/ep100-loss1.072-val_loss0.860.pth',
        'model_path': 'log_voc/ep061-loss0.864-val_loss0.871.pth',
        'num_classes': 21,
        'input_shape': (512, 512),
        'blend': True,
        'cuda': True
    ...
    def detect_image(self, image):
        ...
        with torch.no_grad():
            ...
            np.savetxt('{}/{}.txt'.format(dir_save_path, image), predict, fmt='%d')
...
if __name__ == '__main__':
    segnet_predictor = SegNetPredictor()
    ...
    dir_original_path = '../../data/VOC2007/Predictimg_voc/'
    dir_save_path = '../../data/VOC2007/Predictimg_out/'
    ...
    if mode == 'predict':
        while True:
            ...
            try:
                ...
                r_image = segnet_predictor.detect_image(image)
    ...
    # 视频检测
        ...
        while True:
            ...
            # 进行检测
            frame = np.array(segnet_predictor.detect_image(frame))
    ...
    # 测试fps
        ...
        try:
            ...
            tact_time = segnet_predictor.get_FPS(image, test_interval)
